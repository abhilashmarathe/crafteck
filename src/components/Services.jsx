    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="mt-4 text-sm sm:text-base text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
          ...
          {displayedServices.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                className="group p-6 md:p-8 rounded-3xl bg-white dark:bg-slate-800 shadow-xl hover:-translate-y-3 hover:shadow-2xl transition"
              >
                <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-[#f86e07]/10 flex items-center justify-center mb-5 md:mb-6 group-hover:bg-[#f86e07] transition">
                  <Icon
                    size={26}
                ...
                <p className="mt-3 md:mt-4 text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                  {item.desc}
                </p>
              </motion.div>
            );
        ...
        {limit && (
          <div className="text-center mt-10 md:mt-14">
            <Link
              to="/services"
              className="inline-block w-full sm:w-auto bg-[#f86e07] hover:bg-[#e86200] text-white px-8 py-4 rounded-xl"
            >
              View All Services
            </Link>
          </div>
